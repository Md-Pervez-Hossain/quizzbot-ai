...
const AccountSetting = () => {
  ...
  return (
    <div className="">
      <section
        class="max-w-4xl p-6 lg:px-32 lg:py-16 mx-auto bg-white border border-[#EEE] rounded-xl
         mt-20 mb-20"
      >
            ...
            <div>
              ...
              <div class="mb-1">
                <input
                 ...
                 border-[#eee] mt-2   bg-clip-padding font-normal
            ...
            <div>
              ...
              <input
                ...
                class=" pl-4 placeholder:text-xs block  px-6 py-2 w-full rounded-2xl border-2
                 border-[#eee] mt-2 text-gray-700 bg-white"
              />
            </div>
